            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header border-0">
                        ...
                        <div class="col">
                            <h3 class="mb-0">Edit Hardware</h3>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            {!! Form::model($hardware, ['method' => 'PATCH','route' => ['hardware.update', $hardware->id],'id'=>'addCategory']) !!}
                            @csrf
                             <div class="form-group">
                                ...
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    <div class="input-group-prepend">
                                     ...
                                     {!! Form::text('system_no', null, array('placeholder' => 'System No','class' => 'form-control system_no','readonly'=>"readonly")) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    ...
                                    {!! Form::select('type',$data['type'],$hardware->type, array('class' => 'form-control type','placeholder' => 'Type')) !!}
                            ...
                            <div class="form-group laptop_desktop">
                                ...
                                <label class="label_class">Operating System</label>
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="os" name="operating_system" class="custom-control-input" value="0" {{ isset($hardware->operating_system) && $hardware->operating_system == '0' ? 'checked' : ''}}>
                                        <label class="custom-control-label" for="os">Ubuntu</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="os1" name="operating_system" class="custom-control-input" value="1" {{ isset($hardware->operating_system) && $hardware->operating_system == '1' ? 'checked' : ''}}>
                                        <label class="custom-control-label" for="os1">Windows</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="os2" name="operating_system" class="custom-control-input" value="2" {{ isset($hardware->operating_system) && $hardware->operating_system == '2' ? 'checked' : ''}}>
                            ...
                            <div class="form-group mobile_tablet">
                                ...
                                <div class="input-group radio-butn input-group-merge input-group-alternative mb-3">
                                    ...
                                    <div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="os3" name="operating_system" class="custom-control-input" value="3" {{ isset($hardware->operating_system) && $hardware->operating_system == '3' ? 'checked' : ''}}>
                                            <label class="custom-control-label" for="os3">Android</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" name="operating_system" id="os4" class="custom-control-input" value="4" {{ isset($hardware->operating_system) && $hardware->operating_system == '4' ? 'checked' : ''}}>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group radio-butn input-group-merge input-group-alternative mb-3">
                                    ...
                                    <div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" name="ups" id="ups" class="custom-control-input" {{ isset($hardware->ups) && $hardware->ups == '1' ? 'checked' : ''}} value="1">
                                            <label class="custom-control-label" for="ups">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" name="ups" id="ups2" class="custom-control-input" value="0" {{ isset($hardware->ups) && $hardware->ups == '0' ? 'checked' : ''}}>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group radio-butn input-group-merge input-group-alternative mb-3">
                                    ...
                                    <div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" name="screen" id="screen" class="custom-control-input" value="1" {{ isset($hardware->screen) && $hardware->screen == '1' ? 'checked' : ''}}>
                                            <label class="custom-control-label" for="screen">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" name="screen" id="screen2" class="custom-control-input" value="0" {{ isset($hardware->screen) && $hardware->screen == '0' ? 'checked' : ''}}>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group radio-butn input-group-merge input-group-alternative mb-3">
                                    ...
                                    <div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="keyboard" name="keyboard" class="custom-control-input" {{ isset($hardware->keyboard) && $hardware->keyboard == '1' ? 'checked' : ''}} value="1">
                                            <label class="custom-control-label" for="keyboard">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="keyboard2" name="keyboard" class="custom-control-input" {{ isset($hardware->keyboard) && $hardware->keyboard == '0' ? 'checked' : ''}} value="0">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group radio-butn input-group-merge input-group-alternative mb-3">
                                    ...
                                    <div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="mouse" name="mouse" class="custom-control-input" value="1" {{ isset($hardware->mouse) && $hardware->mouse == '1' ? 'checked' : ''}}>
                                            <label class="custom-control-label" for="mouse">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="mouse2" name="mouse" class="custom-control-input" {{ isset($hardware->mouse) && $hardware->mouse == '0' ? 'checked' : ''}} value="0">
                            ...
                            <div class="form-group mouse_type_div">
                                ...
                                <div class="input-group radio-butn input-group-merge input-group-alternative mb-3">
                                    ...
                                    <div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="mouse_type" name="mouse_type" class="custom-control-input mouse_type" {{ isset($hardware->mouse_type) && $hardware->mouse_type == 'USB' ? 'checked' : ''}} value="USB">
                                            <label class="custom-control-label" for="mouse_type">USB</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="mouse_type2" name="mouse_type" class="custom-control-input mouse_type" {{ isset($hardware->mouse_type) && $hardware->mouse_type == 'Wireless' ? 'checked' : ''}} value="Wireless">
...
$(document).ready(function(){
    ...
    if(type == '3' || type == '4'){
        // $("input[name=operating_system][value=" + type + "]").attr('checked', 'checked');
