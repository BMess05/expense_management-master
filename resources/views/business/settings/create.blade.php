                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            {!! Form::open(array('route' => 'settings.store','method'=>'POST','id'=>'addCategory')) !!}
                            @csrf
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    ...
                                    @endif
                                    {!! Form::select('financial_year',$year_arr,$year, array('class' => 'form-control','placeholder' => 'Financial Year')) !!}
