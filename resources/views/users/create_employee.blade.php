                                    ...
                                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                                        <div class="row">
                                            <div class="col-md-12 mx-0">
                                                <form method="POST" action="{{ route('users.store') }}" id="msform" enctype="multipart/form-data">
                                                    @csrf
                                                    <!-- progressbar -->
                                                    <ul id="progressbar">
                                                                ...
                                                                <div class="col-11">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-10">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-6">
                                                                                    <label for="personal_phone">Personal Phone No.</label>
                                                                                    ...
                                                                                    <div><label for="gender">Gender:</label></div>
                                                                                        <div class="btn-group" data-toggle="buttons">
                                                                                            <label class="btn btn-outline-primary active">
                                                                                                <input type="radio" class="hide-gender" name="gender" id="Male" value="Male" {{ (old('gender') == 'Male') ? 'checked' : '' }}>Male
                                                                                            </label>
                                                                                            <label class="btn btn-outline-primary">
                                                                                                <input type="radio" class="hide-gender" name="gender" id="Female" value="Female" {{ (old('gender') == 'Female') ? 'checked' : '' }}>Female
                                                                                            </label>
                                                                                            <label class="btn btn-outline-primary">
                                                                                                <input type="radio" class="hide-gender" name="gender" id="Others" value="Others" {{ (old('gender') == 'Others') ? 'checked' : '' }}>Others
                                                                                            </label>
                                                                                        </div>
                                                                                        <div class="col-12">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-10">
                                                                            <div class="row">
                                                                                <div class="col-6">
                                                                                    <label for="adhar_card_back">Adhar Card Number </label>
                                                                                ...
                                                                                <div class="col-6">
                                                                                    <label for="adhar_card_back">Pan Card Number </label>
                                                                                    <input type="text" name="pan_no" value="{{ old('pan_no') }}" autocomplete="false" readonly onfocus="this.removeAttribute('readonly');" />
                                                                                    @error('pan_no')
                                                                                    <span class="invalid-feedback" role="alert">
                                                                                        <strong>{{ $message }}</strong>
                                                                                    </span>
                                                                ...
                                                                <div class="col-11">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-4">
                                                                            ...
                                                                            <input type="email" name="official_email" id="official_email" value="{{ old('official_email') }}" />
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-4">
                                                                            ...
                                                                            <input type="text" name="total_experience_till_joining" id="total_experience_till_joining" value="{{ old('total_experience_till_joining') }}">
                                                                        ...
                                                                        <div class="col-4">
                                                                            ...
                                                                            <input type="text" name="ctc" value="{{ old('ctc') }}">
                                                                            @error('ctc')
                                                                            <span class="invalid-feedback" role="alert">
                                                                                <strong>{{ $message }}</strong>
                                                                            </span>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-4">
                                                                            ...
                                                                            {!! Form::select('department', $departments, old('department'), array('class' => 'edepartment')) !!}
                                                                            @error('department')
                                                                            <span class="invalid-feedback" role="alert">
                                                                                <strong>{{ $message }}</strong>
                                                                            </span>
                                                                        ...
                                                                        <div class="col-4">
                                                                            ...
                                                                            {!! Form::select('position', $positions, old('position'), array('class' => 'eposition')) !!}
                                                                            @error('position')
                                                                            <span class="invalid-feedback" role="alert">
                                                                                <strong>{{ $message }}</strong>
                                                                            </span>
                                                                        ...
                                                                        <div class="col-4">
                                                                            ...
                                                                            {!! Form::select('roles', $roles,[], array('class' => 'erole')) !!}
                                                                            @error('roles')
                                                                            <span class="invalid-feedback" role="alert">
                                                                                <strong>{{ $message }}</strong>
                                                                            </span>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-4">
                                                                            <div class="row">
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <input type="radio" name="on_probation" value="1" class="on_probation"> &nbsp; Yes
                                                                                    &nbsp; &nbsp; &nbsp;
                                                                                    <input type="radio" name="on_probation" value="0" class="on_probation"> &nbsp; No
                                                                                    &nbsp; &nbsp; &nbsp;
                                                                                </div>
                                                                                <div class="col-12">
                                                                        ...
                                                                        <div class="col-4">
                                                                            <div class="if-on-probation hide">
                                                                                <label for="expected_probation_complete_date">Expected Probation Complete Date: </label>
                                                                                <input type="date" name="expected_probation_complete_date" id="expected_probation_complete_date" value="{{ old('expected_probation_complete_date') }}">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-4">
                                                                            <div class="if-not-on-probation hide">
                                                                                <label for="allowed_leaves">Allowed Leaves</label>
                                                                                <input type="text" name="allowed_leaves" id="allowed_leaves" value="{{ old('allowed_leaves') }}">
                                                                        ...
                                                                        <div class="col-4">
                                                                            <div class="if-not-on-probation hide">
                                                                                ...
                                                                                <input type="text" name="pending_leaves" id="pending_leaves" value="{{ old('pending_leaves') }}">
                                                                        ...
                                                                        <div class="col-4">
                                                                            <div class="if-not-on-probation hide">
                                                                                ...
                                                                                <input type="date" name="probation_complete_date" id="probation_complete_date" value="{{ old('probation_complete_date') }}">
                                                                ...
                                                                <div class="col-11">
                                                                    <div class="row">
                                                                        <div class="col-4">
                                                                            ...
                                                                            <input type="text" name="emergency_person_name" value="{{ old('emergency_person_name') }}" />
                                                                        ...
                                                                        <div class="col-4">
                                                                            ...
                                                                            {!! Form::select('emergency_person_relation', $relations, old('emergency_person_relation'), array('class' => '')) !!}
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-4">
                                                                            <label for="alt_emergency_person_name">Name Of The Person (Optional)</label>
                                                                            <input type="text" name="alt_emergency_person_name" value="{{ old('alt_emergency_person_name') }}" id="alt_emergency_person_name" />
                                                                        ...
                                                                        <div class="col-4">
                                                                            ...
                                                                            <input type="text" name="alt_emergency_phone" value="{{ old('alt_emergency_phone') }}" />
                                                                        ...
                                                                        <div class="col-4">
                                                                            ...
                                                                            {!! Form::select('alt_emergency_person_relation', $relations, old('alt_emergency_person_relation'), array('class' => '')) !!}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
